...
const All = [
    {
        id: 0,
        name: 'Moein',
        music: 'https://irsv.upmusics.com/dlw/Eshgh%20Man%20Mano%20Seda%20Kon%20(320).mp3',
        musicname: 'Eshghe Man',
    ...
    },
    {
        id: 1,
        name: 'Moein',
        music: 'https://dl.mehrdl.top/Music/A/B/New/Moein%20-%20yade%20to.mp3',
        musicname: 'Yade Tou',
    ...
    },
    {
        id: 3,
        name: 'Moein',
        music: 'https://dl.mehrdl.top/Music/A/E/Moein-panjereh/03%20Ham%20Ghasam.mp3',
    ...
    },
    {
        id: 14,
        name: 'Hayedeh',
        music: 'https://dl.mehrdl.top/Music/A/F/Hayedeh-zendegi/5.Ravi.mp3',
        musicname: 'Ravi',
        ...
        for (let h = 0; h < x.length; h++) {
            ...
            if (num == All[g].id) {
                ...
                document.querySelector('.icon-upload>span>span').style.width = '100%'
                 document.querySelector('.icon-upload>span').style.pointerEvents = 'auto'
                setTimeout(() => {
                    document.querySelector('.icon-upload>span').style.opacity = '0'
                    document.querySelector('.icon-upload>span').style.pointerEvents = 'none'
...
const track2 = document.getElementById('audio');


track.addEventListener('timeupdate', () => {
    seekBar.max = track2.duration;
    seekBar.value = track2.currentTime;
});


seekBar.addEventListener('input', () => {
    track2.currentTime = seekBar.value;
});
